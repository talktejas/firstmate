...
echo "== 2b. answered rows no longer resolvable in the backlog (pruned from Done)"; cp "$home/data/backlog.md" "$home/bk"; awk '/^## Done/{d=1} !d || /^## /' "$home/bk" > "$home/data/backlog.md"; grep -c jt-mfg "$home/data/backlog.md"
