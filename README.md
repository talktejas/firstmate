...
- [docs/command-center.md](docs/command-center.md) - the permanent local page carrying every message firstmate sent you with a box to reply in, the queue still waiting on you across every home, what it can prove about delivery, and how to keep it running.
