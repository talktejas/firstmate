...
- [docs/command-center.md](docs/command-center.md) - the permanent local page listing everything waiting on you across every home, what it can prove about delivery, and how to keep it running.
